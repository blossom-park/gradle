...
"""
        ...
        def resolveCompile = resolveArtifactsInRoot.child("Resolve dependencies :compile")
        ...
        def resolveCompileA = resolveArtifactsInProjectA.child("Resolve dependencies :a:compile")
    ...
    def "generates events for downloading artifacts"() {
        ...
        resolveArtifacts.child("Resolve dependencies :compile").with {
